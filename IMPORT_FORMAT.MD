...
#### devices.csv – bez serial_number

Pokud `serial_number` chybí a není vyplněna kombinace `device_type + manufacturer + model`, **vytvoří se nové zařízení**. To je záměr – duplicita nelze bezpečně rozpoznat.
