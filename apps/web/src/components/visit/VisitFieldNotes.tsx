...
import styles from './VisitFieldNotes.module.css';

const MAX_CHARS = 10_000;

interface VisitFieldNotesProps {
  visitId: string;
...
export function VisitFieldNotes({
  visitId,
  initialContent,
  readOnly = false,
  onSave,
  onChange,
}: VisitFieldNotesProps) {
  ...
  return (
    <div className={styles.container} data-testid="field-notes-editor">
      {!readOnly && (
