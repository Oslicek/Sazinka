...
| # | Task | Status |
|---|------|--------|
| PLAN-01 | JWT_SECRET required + length check | ☐ |
| PLAN-02 | Legacy `user_id` bypass removed | ☐ |
| PLAN-03 | Dev admin password gated behind DEV_MODE | ☐ |
| PLAN-04 | Docker ports bound to 127.0.0.1 | ☐ |
| PLAN-05 | Job submit hard auth | ☐ |
| PLAN-06 | Device IDOR fixed | ☐ |
| PLAN-07 | WorkItem IDOR fixed | ☐ |
| PLAN-08 | All handlers require auth | ☐ |
| PLAN-09 | NATS authentication + ACLs | ☐ |
| PLAN-10 | JWT secret length enforced | ☐ |
