...
> **Last Updated:** 2026-01-30 (v0.12.1)
...
# Job Queue (JetStream)
sazinka.jobs.route              # Submit route planning job to queue
sazinka.job.status.<job_id>     # Real-time job status updates (pub/sub)
...
**In Progress:**
- [ ] Phase 2: Smart Planning (Calendar, Smart suggestions)
